      ...
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 16px" }}>
        ...
        {(() => {
          ...
          const TILES: Tile[] = [
            ...
            ...(blockInfo.state === "current" && (blockInfo as any).block?.subject === "cashout" ? [
              { to: "/cashout", icon: "🪙", label: "Store", desc: dojoPoints != null ? `${dojoPoints} pts` : "Cashout", grad: "linear-gradient(135deg,#fbbf24,#f59e0b)", glow: "rgba(251,191,36,0.35)" } as Tile,
            ] : []),
