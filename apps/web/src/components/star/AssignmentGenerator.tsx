...
const SOCIAL_STUDIES_TOPICS: LocalTopic[] = [
  ...
  // ── Round 3 ──────────────────────────────────────────────
  {
    title: "Holidays in Our Country",
    intro: "Read about special days we celebrate.",
    body: "The United States has many holidays. INDEPENDENCE DAY is on the 4th of July and celebrates when our country became free from England in 1776. People watch fireworks. THANKSGIVING is on the fourth Thursday of November and started with the Pilgrims and the Wampanoag in 1621. Families share a big meal together. MARTIN LUTHER KING JR. DAY is in January and honors a leader who fought for fair treatment for Black Americans. MEMORIAL DAY is in May and honors soldiers who died serving our country. PRESIDENTS' DAY in February honors all U.S. presidents, especially George Washington and Abraham Lincoln. LABOR DAY in September celebrates workers.",
    qa: [
      { text: "What date is Independence Day?", answer: "The 4th of July" },
      { text: "Independence Day celebrates freedom from which country?", answer: "England" },
      { text: "What year did America become free?", answer: "1776" },
      { text: "What month is Thanksgiving?", answer: "November" },
      { text: "Who shared the first Thanksgiving with the Pilgrims?", answer: "The Wampanoag" },
      { text: "What month is Martin Luther King Jr. Day?", answer: "January" },
      { text: "Who does Memorial Day honor?", answer: "Soldiers who died serving our country" },
      { text: "What two presidents are honored on Presidents' Day?", answer: "George Washington and Abraham Lincoln" },
      { text: "What month is Labor Day?", answer: "September" },
      { text: "Who does Labor Day celebrate?", answer: "Workers" },
    ],
    gradeMin: 2, gradeMax: 5,
  },
  {
    title: "Three Branches of Local Government",
    intro: "Read about how our towns and cities are run.",
    body: "Just like the country has a federal government, every town and city has its own LOCAL GOVERNMENT. The leader of a city is called the MAYOR. The mayor works with a CITY COUNCIL — a small group of people elected by the citizens to make rules called ORDINANCES. Local government also includes the POLICE department to keep people safe, the FIRE department to put out fires and respond to emergencies, and PUBLIC WORKS, which fixes roads, runs the water, and picks up trash. Citizens pay TAXES to fund all of these services. We elect new mayors and council members every few years.",
    qa: [
      { text: "What do we call the leader of a city?", answer: "The mayor" },
      { text: "Who works with the mayor to make rules?", answer: "The city council" },
      { text: "How are city council members chosen?", answer: "Elected by the citizens" },
      { text: "What are local rules called?", answer: "Ordinances" },
      { text: "What department keeps people safe?", answer: "The police" },
      { text: "What department puts out fires?", answer: "The fire department" },
      { text: "What does Public Works do?", answer: "Fixes roads, runs water, picks up trash" },
      { text: "What do citizens pay to fund services?", answer: "Taxes" },
      { text: "How often are new mayors elected?", answer: "Every few years" },
      { text: "Does every town have its own local government?", answer: "Yes" },
    ],
    gradeMin: 4, gradeMax: 5,
  },
  {
    title: "Famous Inventors",
    intro: "Read about three people who changed how we live.",
    body: "Many things we use every day were created by INVENTORS. THOMAS EDISON invented the light bulb in 1879, which let people have bright, safe light at home without using fire. ALEXANDER GRAHAM BELL invented the TELEPHONE in 1876, which let people talk to each other across long distances for the first time. The WRIGHT BROTHERS — Orville and Wilbur — flew the first powered airplane in 1903 in North Carolina. Their flight only lasted 12 seconds, but it changed travel forever. All three inventions started with a simple idea and lots of failed tries before they worked.",
    qa: [
      { text: "Who invented the light bulb?", answer: "Thomas Edison" },
      { text: "What year was the light bulb invented?", answer: "1879" },
      { text: "Who invented the telephone?", answer: "Alexander Graham Bell" },
      { text: "What year was the telephone invented?", answer: "1876" },
      { text: "What did the telephone let people do?", answer: "Talk to each other across long distances" },
      { text: "Who flew the first airplane?", answer: "The Wright Brothers" },
      { text: "What were the Wright Brothers' first names?", answer: "Orville and Wilbur" },
      { text: "What year was the first flight?", answer: "1903" },
      { text: "What state was the first flight in?", answer: "North Carolina" },
      { text: "How long did the first flight last?", answer: "12 seconds" },
    ],
    gradeMin: 3, gradeMax: 5,
  },
];
...
const SCIENCE_TOPICS: LocalTopic[] = [
  ...
  {
    title: "Insects",
    intro: "Read about a huge group of tiny animals.",
    body: "INSECTS are the largest group of animals on Earth — there are more insects than all other animals combined. Every insect has SIX legs and THREE body parts: a HEAD, a THORAX in the middle, and an ABDOMEN in the back. Most insects also have ANTENNAE on their head to feel and smell, and most have WINGS. Some examples of insects are ants, bees, butterflies, beetles, and grasshoppers. Spiders are NOT insects — they have eight legs and only two body parts. Insects help us by pollinating flowers and breaking down dead plants. Bees especially help by making honey and pollinating crops we eat.",
    qa: [
      { text: "What is the largest group of animals on Earth?", answer: "Insects" },
      { text: "How many legs does every insect have?", answer: "Six" },
      { text: "How many body parts does an insect have?", answer: "Three" },
      { text: "Name the three body parts of an insect.", answer: "Head, thorax, and abdomen" },
      { text: "What body part is in the middle?", answer: "The thorax" },
      { text: "What do antennae help insects do?", answer: "Feel and smell" },
      { text: "Are spiders insects?", answer: "No" },
      { text: "How many legs does a spider have?", answer: "Eight" },
      { text: "Name two things insects do to help us.", answer: "Pollinate flowers and break down dead plants" },
  ...
  {
    title: "Volcanoes",
    intro: "Read about openings in Earth's surface.",
    body: "A VOLCANO is an opening in Earth's surface where hot melted rock can come up from deep underground. Underground, this melted rock is called MAGMA. When it comes out of a volcano, it is called LAVA. Lava can be over 2,000 degrees Fahrenheit — hot enough to melt almost anything. When a volcano shoots lava, ash, and gas into the air, that's an ERUPTION. Some volcanoes erupt often; some have been quiet for thousands of years. Hawaii is a chain of islands made entirely from underwater volcanoes. The most famous volcano in history is MOUNT VESUVIUS, which erupted in the year 79 AD and buried the Roman city of Pompeii.",
    qa: [
      { text: "What is a volcano?", answer: "An opening in Earth's surface where hot melted rock comes up" },
      { text: "What do we call melted rock underground?", answer: "Magma" },
      { text: "What do we call melted rock when it comes out?", answer: "Lava" },
      { text: "How hot can lava be?", answer: "Over 2,000 degrees Fahrenheit" },
      { text: "What do we call it when a volcano shoots out lava and ash?", answer: "An eruption" },
      { text: "What three things does a volcano shoot during an eruption?", answer: "Lava, ash, and gas" },
      { text: "What chain of islands is made of underwater volcanoes?", answer: "Hawaii" },
      { text: "What is the most famous volcano in history?", answer: "Mount Vesuvius" },
      { text: "What year did Mount Vesuvius erupt?", answer: "79 AD" },
      { text: "What city did Mount Vesuvius bury?", answer: "Pompeii" },
    ],
    gradeMin: 3, gradeMax: 5,
  },
  {
    title: "Simple Machines",
    intro: "Read about six simple tools that help us do work.",
    body: "A SIMPLE MACHINE is a tool with very few parts that makes work easier. There are six simple machines. The LEVER is a stiff bar that pivots — like a seesaw or a crowbar. The WHEEL AND AXLE turns to roll a heavy thing — like a car wheel. The PULLEY is a wheel with a rope around it that helps lift things — like a flagpole rope. The INCLINED PLANE is a ramp — easier than lifting straight up. The WEDGE has a sharp edge that splits things — like an axe or a knife. The SCREW is a wedge wrapped around a pole — it holds things together or lifts. Most complex machines, like a bicycle, are just lots of simple machines combined.",
    qa: [
      { text: "What is a simple machine?", answer: "A tool with few parts that makes work easier" },
      { text: "How many simple machines are there?", answer: "Six" },
      { text: "What is a lever?", answer: "A stiff bar that pivots" },
      { text: "Name an example of a lever.", answer: "A seesaw or a crowbar" },
      { text: "What does a pulley do?", answer: "Helps lift things" },
      { text: "What is an inclined plane?", answer: "A ramp" },
      { text: "What does a wedge do?", answer: "Splits things" },
      { text: "Name an example of a wedge.", answer: "An axe or a knife" },
      { text: "What is a screw?", answer: "A wedge wrapped around a pole" },
      { text: "What complex machine is just lots of simple machines combined?", answer: "A bicycle" },
    ],
    gradeMin: 3, gradeMax: 5,
  },
];
...
const READING_TOPICS: LocalTopic[] = [
  ...
  {
    title: "The New Puppy",
    intro: "Read about a big surprise.",
    body: "Diego came home from school on a Friday and saw a small wiggling box on the kitchen floor. His mom said, 'Open it gently.' Inside was a tiny brown puppy with one white paw. The puppy was a beagle. Diego sat on the floor and the puppy crawled into his lap. His mom told him the puppy was eight weeks old and would need a name. Diego thought hard. He looked at the white paw and said, 'I'm calling him Sock.' That night, Sock slept in a small bed in Diego's room. He whined twice but went back to sleep when Diego patted him.",
    qa: [
      { text: "What is the boy's name?", answer: "Diego" },
      { text: "What day was it?", answer: "Friday" },
      { text: "Where was the box?", answer: "On the kitchen floor" },
      { text: "What was inside the box?", answer: "A small brown puppy" },
      { text: "What kind of dog is the puppy?", answer: "A beagle" },
      { text: "What was special about the puppy's paw?", answer: "It was white" },
      { text: "How old is the puppy?", answer: "Eight weeks" },
      { text: "What did Diego name the puppy?", answer: "Sock" },
      { text: "Where did Sock sleep?", answer: "In a small bed in Diego's room" },
      { text: "How many times did Sock whine?", answer: "Twice" },
    ],
    gradeMin: 1, gradeMax: 2,
  },
  {
    title: "The Talent Show",
    intro: "Read about Aisha's big night.",
    body: "Every spring, Maple Elementary holds a talent show in the gym. This year, Aisha — a quiet third-grader — signed up to play piano in front of the whole school. She practiced 'Twinkle Twinkle Little Star' every day for six weeks. On the night of the show, the gym was packed with 300 people. Aisha's stomach felt like it had butterflies in it. When her name was called, she walked to the small black piano on the stage. She took one deep breath and started playing. She missed only ONE note in the whole song. When she finished, everyone clapped, and her dad whistled the loudest of anyone. Aisha smiled the entire walk back to her seat.",
    qa: [
      { text: "What is the school's name?", answer: "Maple Elementary" },
      { text: "What season is the talent show?", answer: "Spring" },
      { text: "Where is the talent show held?", answer: "In the gym" },
      { text: "What grade is Aisha in?", answer: "Third grade" },
      { text: "What instrument did Aisha play?", answer: "Piano" },
      { text: "What song did Aisha play?", answer: "Twinkle Twinkle Little Star" },
      { text: "How long did she practice?", answer: "Six weeks" },
      { text: "How many people were in the gym?", answer: "300" },
      { text: "How many notes did Aisha miss?", answer: "One" },
      { text: "Who whistled the loudest?", answer: "Aisha's dad" },
    ],
    gradeMin: 2, gradeMax: 4,
  },
  {
    title: "The Robot in the Garage",
    intro: "Read about a kid inventor.",
    body: "Eleven-year-old Devon spent every Saturday in his grandfather's garage building a small robot out of cardboard, an old motor, and a pair of broken headphones. He called the robot CHIP. CHIP could do exactly one trick: roll three feet forward and then beep twice. It took Devon four months to get even that to work. His grandfather, a retired engineer, helped Devon learn how to solder wires safely. When Devon finally showed CHIP to his class, his teacher asked if she could show CHIP to the principal. The principal was so impressed that he invited Devon to enter the district science fair. CHIP did not win — it came in third — but Devon got a small trophy and, more importantly, the idea for an even better robot.",
    qa: [
      { text: "How old is Devon?", answer: "Eleven years old" },
      { text: "Where did Devon work on his robot?", answer: "In his grandfather's garage" },
      { text: "Name two materials Devon used.", answer: "Cardboard, an old motor, or broken headphones" },
      { text: "What did Devon name the robot?", answer: "CHIP" },
      { text: "What trick could CHIP do?", answer: "Roll three feet forward and beep twice" },
      { text: "How long did it take Devon to build CHIP?", answer: "Four months" },
      { text: "What was the grandfather's old job?", answer: "Engineer" },
      { text: "What skill did the grandfather teach Devon?", answer: "How to solder wires safely" },
      { text: "What place did CHIP get at the science fair?", answer: "Third" },
      { text: "What did Devon get from the science fair?", answer: "A small trophy and the idea for a better robot" },
    ],
    gradeMin: 4, gradeMax: 5,
  },
];
...
const WRITING_TOPICS: LocalTopic[] = [
  ...
  // ── Round 3 ──────────────────────────────────────────────
  {
    title: "Adjectives That Describe",
    intro: "Read about words that paint a picture.",
    body: "An ADJECTIVE is a word that DESCRIBES a noun. Adjectives tell what KIND, how MANY, or which ONE. The cat is BLACK. (What kind?) There were FIVE cats. (How many?) THAT cat is mine. (Which one?) Strong adjectives make your writing more interesting. Instead of 'the dog,' write 'the fluffy little dog.' Instead of 'the food,' write 'the spicy food' or 'the cold food.' Color words (red, blue), size words (big, tiny), and feeling words (happy, scared) are all adjectives. A good rule: try to use one adjective in every sentence to help the reader picture what you mean.",
    qa: [
      { text: "What is an adjective?", answer: "A word that describes a noun" },
      { text: "Adjectives can tell what kind, how many, or which what?", answer: "Which one" },
      { text: "What does the adjective in 'the cat is black' tell?", answer: "What kind" },
      { text: "What does the adjective in 'there were five cats' tell?", answer: "How many" },
      { text: "Why use strong adjectives?", answer: "To make writing more interesting" },
      { text: "Are color words adjectives?", answer: "Yes" },
      { text: "Are size words adjectives?", answer: "Yes" },
      { text: "Are feeling words adjectives?", answer: "Yes" },
      { text: "What is the rule for adjectives in your writing?", answer: "Use one in every sentence" },
      { text: "Why do adjectives help the reader?", answer: "They help the reader picture what you mean" },
    ],
    gradeMin: 2, gradeMax: 4,
  },
  {
    title: "Topic Sentences and Closing Sentences",
    intro: "Read about how to start and finish a paragraph.",
    body: "A good paragraph has a STRONG START and a STRONG END. The first sentence is the TOPIC SENTENCE. It tells the reader what the paragraph will be about. Example topic sentence: 'My favorite season is summer.' Then come 3 to 5 DETAIL SENTENCES that give reasons or examples. The last sentence is the CLOSING SENTENCE. It wraps up the paragraph by restating the main idea in a different way. Example closing: 'For all these reasons, summer is the best.' Without a topic sentence, the reader feels lost. Without a closing sentence, the paragraph feels unfinished — like a song that just stops in the middle.",
    qa: [
      { text: "What does a good paragraph have at the start and end?", answer: "A strong start and a strong end" },
      { text: "What is the first sentence of a paragraph called?", answer: "The topic sentence" },
      { text: "What does the topic sentence tell the reader?", answer: "What the paragraph will be about" },
      { text: "How many detail sentences come after the topic sentence?", answer: "Three to five" },
      { text: "What is the last sentence called?", answer: "The closing sentence" },
      { text: "What does the closing sentence do?", answer: "Wraps up the paragraph by restating the main idea" },
      { text: "What does a closing sentence restate?", answer: "The main idea in a different way" },
      { text: "How does the reader feel without a topic sentence?", answer: "Lost" },
      { text: "What does a paragraph without a closing feel like?", answer: "Unfinished, like a song that stops in the middle" },
      { text: "Give an example of a topic sentence from the story.", answer: "My favorite season is summer" },
    ],
    gradeMin: 3, gradeMax: 5,
  },
];
...
const SPELLING_TOPICS: LocalTopic[] = [
  ...
  // ── Round 3 ──────────────────────────────────────────────
  {
    title: "R-Controlled Vowels: ar, er, ir, or, ur",
    intro: "Read about how the letter R changes vowels.",
    body: "When the letter R comes right after a vowel, the R changes the vowel's sound. We call these R-CONTROLLED VOWELS. AR sounds like the word 'are' — as in 'car,' 'star,' and 'park.' OR sounds like 'or' — as in 'horse,' 'fork,' and 'corn.' ER, IR, and UR all sound the same — like 'er' in 'her.' For example, 'her,' 'bird,' and 'turn' all rhyme even though they're spelled with different vowels. There is no easy rule for choosing er, ir, or ur — you just have to remember which one each word uses. Try saying these words out loud: car, fork, bird, turn, her. Hear how the R takes over the vowel sound.",
    qa: [
      { text: "What do we call vowels followed by the letter R?", answer: "R-controlled vowels" },
      { text: "What sound does AR make?", answer: "Like the word 'are'" },
      { text: "Spell a word with AR.", answer: "car, star, or park" },
      { text: "What sound does OR make?", answer: "Like 'or'" },
      { text: "Spell a word with OR.", answer: "horse, fork, or corn" },
      { text: "Which three R-controlled vowels sound the same?", answer: "er, ir, and ur" },
      { text: "Spell a word with ER.", answer: "her" },
      { text: "Spell a word with IR.", answer: "bird" },
      { text: "Spell a word with UR.", answer: "turn" },
      { text: "Is there a rule for choosing er, ir, or ur?", answer: "No, you just have to remember each word" },
    ],
    gradeMin: 1, gradeMax: 3,
  },
  {
    title: "Suffixes: -ed, -ing, -er, -est",
    intro: "Read about word endings that change a word's meaning.",
    body: "A SUFFIX is a small group of letters added to the END of a word. Suffixes change WHEN something happens or HOW MUCH. -ED makes a word past tense: walk → walked, jump → jumped. -ING means it's happening right now: walk → walking, jump → jumping. -ER compares two things: small → smaller, fast → faster. -EST is the most extreme of all: small → smallest, fast → fastest. Quick spelling rule: when a word ends in a single vowel + single consonant, you usually DOUBLE the consonant before adding -ed or -ing — like 'run → running' (NOT 'runing').",
    qa: [
      { text: "What is a suffix?", answer: "A small group of letters added to the end of a word" },
      { text: "What does -ed do to a word?", answer: "Makes it past tense" },
      { text: "What is the past tense of 'walk'?", answer: "Walked" },
      { text: "What does -ing mean?", answer: "It's happening right now" },
      { text: "What does -er do?", answer: "Compares two things" },
      { text: "What is the comparison form of 'small'?", answer: "Smaller" },
      { text: "What does -est mean?", answer: "The most extreme" },
      { text: "What is the most-extreme form of 'fast'?", answer: "Fastest" },
      { text: "When do you double the consonant before -ed or -ing?", answer: "When a word ends in a single vowel + single consonant" },
      { text: "Spell 'run' with -ing.", answer: "Running" },
    ],
    gradeMin: 2, gradeMax: 4,
  },
  {
    title: "Silent Letters: kn, wr, mb, gh",
    intro: "Read about letters that you don't say.",
    body: "Some words have letters you do NOT say when you read them out loud. These are SILENT LETTERS. KN at the start of a word: the K is silent. 'Knee' sounds like 'nee.' 'Knife' sounds like 'nife.' 'Knight' sounds like 'nite.' WR at the start: the W is silent. 'Write' sounds like 'rite.' 'Wrong' sounds like 'rong.' MB at the end: the B is silent. 'Lamb' sounds like 'lam.' 'Thumb' sounds like 'thum.' 'Comb' sounds like 'com.' GH in the middle or end is often silent: 'night,' 'right,' and 'though' all have a silent GH. These letters used to be pronounced hundreds of years ago, but English changed and we kept the spellings.",
    qa: [
      { text: "What do we call letters you don't say?", answer: "Silent letters" },
      { text: "In KN at the start of a word, which letter is silent?", answer: "The K" },
      { text: "How is 'knee' pronounced?", answer: "Nee" },
      { text: "How do you spell the word that means a sharp tool for cutting?", answer: "Knife" },
      { text: "In WR at the start of a word, which letter is silent?", answer: "The W" },
      { text: "How is 'write' pronounced?", answer: "Rite" },
      { text: "In MB at the end of a word, which letter is silent?", answer: "The B" },
      { text: "How do you spell the word for a baby sheep?", answer: "Lamb" },
      { text: "How do you spell the word that means the opposite of left?", answer: "Right" },
      { text: "Why do English words still have silent letters?", answer: "English changed but we kept the spellings" },
    ],
    gradeMin: 2, gradeMax: 5,
  },
];
...
const SEL_TOPICS: LocalTopic[] = [
  ...
  // ── Round 3 ──────────────────────────────────────────────
  {
    title: "Asking for a Break (Without Quitting)",
    intro: "Read about a tool to use when you feel overwhelmed.",
    body: "Sometimes your brain or body needs a small reset before you can keep going. That's what a BREAK is for. A break is NOT quitting — it's a tool. There are three kinds. A BODY BREAK is when you stand up, stretch, or get a drink (about 1 to 3 minutes). A QUIET BREAK is when you put your head down or use a calming corner with low light (about 3 to 5 minutes). A MOVEMENT BREAK is when you walk to the office and back, do wall push-ups, or use a fidget (about 5 minutes). The right way to ask: 'I need a break, please. I'll be back in __ minutes.' Then YOU come back without being told. Adults trust kids who use breaks the right way and start saying yes more often.",
    qa: [
      { text: "Is a break the same as quitting?", answer: "No, a break is a tool" },
      { text: "How many kinds of breaks are there?", answer: "Three" },
      { text: "What is a body break?", answer: "Standing up, stretching, or getting a drink" },
      { text: "How long is a body break?", answer: "1 to 3 minutes" },
      { text: "What is a quiet break?", answer: "Putting your head down or using a calming corner" },
      { text: "How long is a quiet break?", answer: "3 to 5 minutes" },
      { text: "What is a movement break?", answer: "Walking, wall push-ups, or a fidget" },
      { text: "How long is a movement break?", answer: "5 minutes" },
      { text: "What is the right way to ask for a break?", answer: "I need a break, please. I'll be back in __ minutes" },
      { text: "Why do adults trust kids who use breaks well?", answer: "They come back without being told" },
    ],
    gradeMin: 2, gradeMax: 5,
  },
  {
    title: "Two Sides to Every Story",
    intro: "Read about why hearing both sides matters.",
    body: "When something goes wrong between two people, both kids usually have a different version of what happened. Both kids often think THEY are the one who got treated unfairly. That doesn't mean either is lying — it means each one only saw part of the story. A good adult listens to BOTH sides before deciding anything. They might ask each kid: 'What happened first?' 'What did you do then?' 'How did that feel?' This is called HEARING BOTH SIDES, and it almost always changes what looked like the truth at first. The goal is NOT to win or to prove the other kid wrong — it's to understand what actually happened so you can make it right. The same is true for arguments at home.",
    qa: [
      { text: "When something goes wrong, how many sides are there usually?", answer: "Two" },
      { text: "Do both kids usually think they were treated unfairly?", answer: "Yes" },
      { text: "Does that mean someone is lying?", answer: "No, each one only saw part of the story" },
      { text: "What does a good adult listen to before deciding?", answer: "Both sides" },
      { text: "Name one question a good adult might ask.", answer: "What happened first?" },
      { text: "What is this called?", answer: "Hearing both sides" },
      { text: "What is the goal of hearing both sides?", answer: "To understand what actually happened" },
      { text: "Is the goal to win or prove the other kid wrong?", answer: "No" },
      { text: "Where else does this apply besides school?", answer: "At home / in arguments at home" },
      { text: "What does hearing both sides almost always do?", answer: "Change what looked like the truth at first" },
    ],
    gradeMin: 3, gradeMax: 5,
  },
];
