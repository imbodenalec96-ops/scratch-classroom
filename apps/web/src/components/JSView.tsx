...
export default function JSView({ sprites }: Props) {
  ...
  return (
    <div className="h-full bg-[#0d0d1a] rounded-xl border border-white/[0.06] overflow-hidden flex flex-col">
      ...
      <pre className="flex-1 p-4 overflow-auto text-sm font-mono leading-relaxed text-emerald-300/90">
