...
const CONTENT: Record<
  string,
  Record<number, { title: string; description: string; content: any }>
> = {
  reading: {
    1: {
      title: "1st Grade Reading: Simple Words",
      description: "Read simple sight words and answer questions.",
      content: {
        title: "Simple Words",
        subject: "Reading",
        grade: "1st Grade",
            ...
            questions: [
              {
                ...
                text: "Which word names a furry pet that says 'meow'?",
              ...
              {
                type: "multiple_choice",
                text: "Which word names a fruit that is red and grows on trees?",
              ...
              {
                type: "multiple_choice",
                text: "Which word names the color of fire trucks and stop signs?",
              ...
              {
                type: "multiple_choice",
                text: "Which animal is the smallest?",
                options: ["A. elephant", "B. whale", "C. ant", "D. giraffe"],
                correctIndex: 2,
                points: 6,
              },
              {
        ...
        sections: [
          {
            ...
            questions: [
              {
                type: "multiple_choice",
                text: "What does 'cat' rhyme with?",
                options: ["A. dog", "B. bat", "C. tree", "D. run"],
                correctIndex: 1,
                points: 8,
              },
              {
                ...
                text: "What is a 'hat'?",
                options: [
                  "A. you wear on your foot",
                  "B. you wear on your head",
                  "C. you sit on",
                  "D. you eat",
                ],
                correctIndex: 1,
              ...
              {
                type: "fill_blank",
                text: "A 'pot' is something you use to ___.",
                correctAnswer: "cook",
                points: 8,
              },
              {
                type: "fill_blank",
                text: "When you 'run' you are moving ___.",
                correctAnswer: "fast or quickly",
                points: 8,
              },
              {
                type: "short_answer",
                text: "What does 'sit' mean?",
                correctAnswer: "to be in a chair or down",
                points: 8,
              },
            ],
          },
        ...
        sections: [
          {
            ...
            questions: [
              ...
              {
                type: "fill_blank",
                text: "Max was _____ when he found something interesting.",
                correctAnswer: "excited or happy",
                points: 10,
              },
              {
                type: "short_answer",
                text: "What did Max do after finding the treasure?",
                correctAnswer: "shared it or brought it home",
                points: 10,
              },
              {
                type: "short_answer",
                text: "What is the lesson of this story?",
                correctAnswer: "adventure or exploration or curiosity",
                points: 10,
              },
            ],
          },
        ...
        sections: [
          {
            ...
            questions: [
              ...
              {
                type: "multiple_choice",
                text: "How did the environment of the island affect the story?",
                options: [
                  "A. it had no effect",
                  "B. it created challenges and mysteries",
              ...
              {
                type: "fill_blank",
                text: "The ancient structures suggested that the island was once _____ by a civilization.",
                correctAnswer: "inhabited or occupied",
                points: 12,
              },
              {
                type: "short_answer",
                text: "What is the author's tone in describing the discovery?",
                correctAnswer: "curious, thoughtful, or reverent",
                points: 12,
              },
              {
                type: "short_answer",
                text: "What does this story suggest about human curiosity and exploration?",
                correctAnswer: "it drives discovery or it reveals history",
                points: 12,
              },
            ],
          },
        ...
        sections: [
          {
            ...
            questions: [
              {
                type: "multiple_choice",
                text: "If you have 2 apples and I give you 1 more, how many do you have?",
              ...
              {
                type: "multiple_choice",
                text: "Count: 1, 2, ___, 4, 5. What comes next?",
              ...
              {
                type: "fill_blank",
                text: "If you have 3 toys and lose 1, you have ___ toys left.",
                correctAnswer: "2",
                points: 8,
              },
              {
              ...
              {
                type: "short_answer",
                text: "If you have 2 cats and 1 dog, how many pets do you have?",
                correctAnswer: "3",
                points: 8,
              },
            ],
        ...
        sections: [
          {
            ...
            questions: [
              ...
              {
                type: "short_answer",
                text: "Tom has 8 marbles. He wins 3 more. How many does he have now?",
                correctAnswer: "11",
                points: 10,
              },
            ],
        ...
        sections: [
          {
            ...
            questions: [
              {
                type: "multiple_choice",
                text: "3 groups of 2 equals: 2 + 2 + 2 = ?",
                options: ["A. 5", "B. 6", "C. 7", "D. 8"],
                correctIndex: 1,
                points: 10,
              },
              ...
              {
                type: "short_answer",
                text: "If you have 4 bags with 3 apples each, how many apples total?",
                correctAnswer: "12",
                points: 10,
              },
            ],
        ...
        sections: [
          {
            ...
            questions: [
              ...
              {
                type: "short_answer",
                text: "A bookstore has 13 shelves with 6 books each. How many books total?",
                correctAnswer: "78",
                points: 10,
              },
            ],
            ...
            questions: [
              {
                type: "multiple_choice",
                text: "0.5 + 0.25 = ?",
                options: ["A. 0.7", "B. 0.75", "C. 0.8", "D. 0.9"],
                correctIndex: 1,
                points: 10,
              },
              {
                type: "multiple_choice",
                text: "1/2 + 1/4 = ?",
                options: ["A. 1/6", "B. 2/6", "C. 3/4", "D. 3/8"],
                correctIndex: 2,
                points: 10,
              },
              {
              ...
              },
              {
                type: "fill_blank",
                text: "3/4 ÷ 1/2 = ___",
                correctAnswer: "1.5 or 3/2",
                points: 10,
              },
              {
                type: "short_answer",
                text: "A recipe calls for 2.5 cups of flour. If you double it, how much flour do you need?",
                correctAnswer: "5",
                points: 10,
              },
            ],
  ...
  writing: {
        ...
        sections: [
          {
            ...
            questions: [
              {
                type: "short_answer",
                text: "Copy the letter 'A':",
                lines: 2,
                points: 5,
              },
              {
                type: "short_answer",
                text: "Copy the word 'cat':",
                lines: 2,
                points: 5,
              },
              {
                type: "short_answer",
                text: "Copy the word 'dog':",
                lines: 2,
                points: 5,
              },
              {
                type: "short_answer",
                text: "Write the first letter of your name:",
                lines: 2,
                points: 5,
              },
              {
                type: "short_answer",
                text: "Draw and write about your favorite animal:",
                lines: 3,
                points: 5,
              },
            ],
        ...
        sections: [
          {
            ...
            questions: [
              {
                type: "short_answer",
                text: "Write a sentence about your favorite food.",
                lines: 3,
                points: 10,
              },
              {
                type: "short_answer",
                text: "Write a sentence about what you did today.",
                lines: 3,
                points: 10,
              },
              {
                type: "short_answer",
                text: "Write a question about animals.",
                lines: 3,
                points: 10,
              },
              {
                type: "short_answer",
                text: "Write a sentence about the weather.",
                lines: 3,
                points: 10,
              },
            ],
    ...
    3: {
      ...
      content: {
        ...
        grade: "3rd Grade",
        instructions:
          "Write a paragraph (4-5 sentences) about something that happened to you.",
        totalPoints: 50,
        sections: [
          {
            ...
            questions: [
              {
                type: "short_answer",
                text: "Write about a time you had fun with a friend. Include what you did, where you were, and how it made you feel.",
                lines: 6,
                points: 50,
              },
            ],
    ...
    5: {
      ...
      content: {
        ...
        grade: "5th Grade",
        instructions:
          "Write a paragraph expressing your opinion with 2-3 reasons and examples.",
        totalPoints: 60,
        sections: [
          {
            ...
            questions: [
              {
                type: "short_answer",
                text: "What is your favorite season? Write why you like it. Include at least 2-3 reasons with examples.",
                lines: 8,
                points: 60,
              },
            ],
  ...
  spelling: {
    0: {
      title: "Kindergarten Spelling: Basic Words",
      description: "Spell simple 3-letter words.",
      content: {
        title: "Kindergarten Spelling",
        subject: "Spelling",
        grade: "Kindergarten",
        instructions: "Fill in the missing letter for each word.",
        totalPoints: 25,
        sections: [
          {
            ...
            questions: [
              {
                type: "fill_blank",
                text: "c_t (a furry pet)",
                correctAnswer: "a",
                points: 5,
              },
              {
                type: "fill_blank",
                text: "d_g (a barking pet)",
                correctAnswer: "o",
                points: 5,
              },
              {
                type: "fill_blank",
                text: "s_n (shines in the sky)",
                correctAnswer: "u",
                points: 5,
              },
              {
              ...
              {
                type: "short_answer",
                text: "Spell the word for a thing you sit on:",
                correctAnswer: "chair",
                points: 5,
              },
            ],
    ...
    1: {
      title: "1st Grade Spelling: Short Vowel Words",
      description: "Spell short vowel CVC words.",
      content: {
        title: "1st Grade Spelling",
        subject: "Spelling",
        grade: "1st Grade",
        instructions: "Spell the word that matches each clue.",
        totalPoints: 30,
        sections: [
          {
            title: "Short Vowel Spelling",
            questions: [
              {
                type: "short_answer",
                text: "Spell the word: a small insect (b_g)",
                correctAnswer: "bug",
                points: 6,
              },
              {
                type: "short_answer",
                text: "Spell the word: you wear on your head (h_t)",
                correctAnswer: "hat",
                points: 6,
              },
              {
                type: "short_answer",
                text: "Spell the word: opposite of hot (c_ld)",
                correctAnswer: "cold",
                points: 6,
              },
              {
                type: "short_answer",
                text: "Spell the word: a number after 9 (t_n)",
                correctAnswer: "ten",
                points: 6,
              },
              {
                type: "short_answer",
                text: "Spell the word: you sleep in it (b_d)",
                correctAnswer: "bed",
                points: 6,
              },
            ],
    ...
    2: {
      title: "2nd Grade Spelling: Sight Words",
      description: "Spell common sight words correctly.",
      content: {
        title: "2nd Grade Spelling",
        subject: "Spelling",
        grade: "2nd Grade",
        instructions: "Choose the correct spelling for each word.",
        totalPoints: 40,
        sections: [
          {
            title: "Sight Word Spelling",
            questions: [
              {
                type: "multiple_choice",
              ...
              },
              {
                type: "multiple_choice",
                text: "Which is spelled correctly?",
                options: ["A. frend", "B. freind", "C. friend", "D. friand"],
                correctIndex: 2,
                points: 8,
              },
              {
                type: "multiple_choice",
                text: "Which is spelled correctly?",
                options: ["A. peple", "B. peeple", "C. pepole", "D. people"],
                correctIndex: 3,
                points: 8,
              },
              {
                type: "short_answer",
                text: "Spell the word that means 'a lot': m_ny",
                correctAnswer: "many",
                points: 8,
              },
              {
                type: "short_answer",
                text: "Spell the opposite of 'come': g_",
                correctAnswer: "go",
                points: 8,
              },
            ],
    ...
    3: {
      title: "3rd Grade Spelling: Long Vowel Words",
      description: "Spell words with long vowel sounds.",
      content: {
        title: "3rd Grade Spelling",
        subject: "Spelling",
        grade: "3rd Grade",
        instructions: "Spell these long vowel words correctly.",
        totalPoints: 50,
        sections: [
          {
            title: "Long Vowel Spelling",
            questions: [
              {
                type: "multiple_choice",
                text: "Which is spelled correctly?",
                options: ["A. straet", "B. streat", "C. street", "D. streeat"],
                correctIndex: 2,
                points: 10,
              },
              {
                type: "multiple_choice",
                text: "Which is spelled correctly?",
                options: ["A. trane", "B. train", "C. trayn", "D. trean"],
                correctIndex: 1,
                points: 10,
              },
              {
                type: "short_answer",
                text: "Spell the word: a thing you dream of achieving (g__l)",
                correctAnswer: "goal",
                points: 10,
              },
              {
                type: "short_answer",
                text: "Spell the word: a large body of water (o___n)",
                correctAnswer: "ocean",
                points: 10,
              },
              {
                type: "short_answer",
                text: "Spell the word: opposite of night (d__)",
                correctAnswer: "day",
                points: 10,
              },
            ],
    ...
    5: {
      title: "5th Grade Spelling: Academic Vocabulary",
      description: "Spell grade-level academic vocabulary words.",
      content: {
        title: "5th Grade Spelling",
        subject: "Spelling",
        grade: "5th Grade",
        instructions: "Spell these academic vocabulary words correctly.",
        totalPoints: 50,
        sections: [
          {
            title: "Academic Vocabulary Spelling",
            questions: [
              {
                type: "multiple_choice",
                text: "Which is spelled correctly?",
              ...
              {
                type: "short_answer",
                text: "Spell the word that means 'to look at carefully': obs___ve",
                correctAnswer: "observe",
                points: 10,
              },
              {
                type: "short_answer",
                text: "Spell the word that means 'a conclusion based on evidence': inf___ence",
                correctAnswer: "inference",
                points: 10,
              },
              {
                type: "short_answer",
                text: "Spell the word that means 'to show or display': dem___strate",
...
const SEL_CONTENT = {
  ...
  content: {
    ...
    grade: "All Grades",
    instructions:
      "Watch the video about growth mindset. Then answer the reflection questions.",
    totalPoints: 40,
        ...
        questions: [
          {
            ...
            options: [
              "A. Believing you can't change",
              "B. Believing you can learn and grow with effort",
              "C. Giving up when something is hard",
              "D. Being afraid of mistakes",
            ],
            correctIndex: 1,
            points: 10,
          },
          {
            type: "short_answer",
            text: "Describe a time when you faced a challenge and learned from it.",
            lines: 4,
            points: 15,
          },
          {
            type: "short_answer",
            text: "What's one thing you want to get better at? How will you use a growth mindset to help?",
            lines: 4,
            points: 15,
          },
        ],
...
router.post("/ensure-star-class", async (req, res) => {
  try {
    ...
    await db
      .prepare(`INSERT INTO classes (id, name, code) VALUES (?, ?, ?)`)
  ...
  try {
    ...
    for (const name of Object.keys(STUDENTS)) {
      const row: any = await db
        .prepare(
          `SELECT id FROM users WHERE role = 'student' AND name LIKE ? LIMIT 1`,
        )
        .get(`%${name}%`);
    ...
    for (const subject of ["reading", "math", "writing", "spelling"] as const) {
      ...
      const gradeSet = new Set(
        Object.values(GRADE_MATRIX).map((g) => g[gradeField]),
      );
        ...
        await db
          ...
          .run(
            ...
            JSON.stringify([
              {
                label: "Correctness",
                maxPoints: premade.content.totalPoints || 50,
              },
            ]),
...
router.post("/reset-star-assignments", (req, res) =>
...
router.get("/pending-check", async (req, res) => {
  ...
  try {
    ...
    for (const p of allPending) {
      for (const r of p.rows) {
        if (r.target_student_ids) {
          let ids: string[] = [];
          try {
            const parsed = JSON.parse(r.target_student_ids);
          ...
          if (ids.length > 0 && ids.includes(student.id))
            filtered.push({
              ...
              title: r.title,
              included: true,
              reason: "in target_student_ids",
            });
          else if (ids.length > 0)
            filtered.push({
              title: r.title,
              included: false,
              reason: `not in ids: ${ids.slice(0, 2).join(",")}...`,
            });
        }
      }
    }
    ...
    res.json({
      ...
      classes,
      grades,
      rawTotalRows: allPending.reduce((s, p) => s + p.rawCount, 0),
      simulatedFiltered: filtered,
    });
  } catch (e: any) {
...
router.get("/class-info", async (_req, res) => {
  try {
    const starClass: any = await db
      .prepare(
        `SELECT id, name FROM classes WHERE name LIKE '%star%' ORDER BY created_at LIMIT 1`,
      )
      .get();
...
router.post("/create-assignment", async (req, res) => {
  try {
    const { title, subject, grade, studentIds, date, passage, questions } =
      req.body as {
        title: string;
        subject: string;
        grade: number;
    ...
    const classRow = await db
      .prepare(
        `SELECT DISTINCT cm.class_id FROM class_members cm
         ...
         WHERE cm.user_id::text = ? AND c.name LIKE '%Star%'
         LIMIT 1`,
      )
      .get(studentIds[0]);

    const classId =
      classRow?.class_id ?? "0a635d79-4028-480c-8240-652a67bd973d";
